...
int main(void)
{
  ...
  run_test(test_apagar_un_led , "test_apagar_un_led ", 30);
  run_test(test_prender_y_apagar_varios_leds , "test_prender_y_apagar_varios_leds ", 38);
  run_test(test_encender_todos_los_leds , "test_encender_todos_los_leds ", 58);
  run_test(test_apagar_todos_los_leds , "test_apagar_todos_los_leds ", 65);
  run_test(test_estado_leds , "test_estado_leds ", 72);
